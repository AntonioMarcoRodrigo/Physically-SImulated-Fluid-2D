...
//Arrays de propiedades bidimensionales
class Fluid2
{
public:
...
public:
	...
	//Velicdades, presión y tinta. La tinta es la cantidad de humo por celdilla (meramente visual)
	//Solo hay que aplicarle la ecuación de convección (el semilagrangiano), La tinta, como las presiones, está definida en los centros de celda

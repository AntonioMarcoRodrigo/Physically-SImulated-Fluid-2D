...
//Para almacenar campos escalares
//Tamaño de rejilla, automaticamente reserva la memoria para el array interno, con sus metodos para acceder a sus diferentes elementos (getValue)
template< class T >
class Array2
{
public:
